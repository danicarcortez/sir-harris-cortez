  ...
  <section className="mb-8">
    ...
    <Accordion collapseAll>
      <AccordionPanel>
        ...
        <AccordionContent>
          <p className="mb-2 text-gray-500 dark:text-gray-400">Most of the time, we are out for 3-4 hours.</p>

          <p className="mb-2 text-gray-500 dark:text-gray-400">
            Our agenda typically consists of anchoring near the Lake Travis Zipline Adventure cove and swimming in the water. Then, we typically do some water
            tubing, then finish off by jumping back in the water by Sandy Creek Cove before heading back to the marina.
          </p>
        </AccordionContent>
      </AccordionPanel>
      <AccordionPanel>
        ...
        <AccordionContent>
          ...
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            We don&apos;t recommend bringing a large cooler because space is limited. You can instead bring ice and we can use the onboard cooler that is on the
            boat.
          </p>
        </AccordionContent>
      </AccordionPanel>
      ...
      <AccordionPanel>
        ...
        <AccordionContent>
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            If you&apos;d like to dine while boating, please let us know in advance so we can make the necessary arrangements! Here are some of our favorites:
          </p>
          <List>
            <ListItem>
