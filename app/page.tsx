        ...
        <div className="flex items-center py-5 md:w-1/2 md:pb-20 md:pt-10 md:pr-10">
          <div className="text-left">
            ...
            <p className="max-w-md mx-auto mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              ...
              questions or need further information, don’t hesitate to reach
              out!
            </p>
          </div>
        </div>
        ...
        <Timeline>
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <TimelineBody>
                <List>
                  <ListItem>
                    <strong>Life Jackets</strong> Coast Guard-approved, one per
                    person. We have extras available; just let us know what you
                    need!
                  </ListItem>
                  <List nested>
                    <ListItem>
                      [0-30 lbs] Infant Life Jacket with crotch strap (2 extras)
                    </ListItem>
                    <ListItem>
                      [30-55 lbs] Toddler Life Jacket with crotch strap (3
                      extras)
                    </ListItem>
                  ...
                  <ListItem>
                    <strong>Hydration</strong> Stay hydrated! We recommend using
                    a tumbler to keep drinks cold.
                  </ListItem>
                  <ListItem>
                    <strong>Snacks</strong> Please bring snacks that won&apos;t
                    stain (our seats are white).
                  </ListItem>
                  <List nested>
                    <ListItem>
                  ...
                  <ListItem>
                    <strong>Note</strong>: We highly recommend bringing a
                    stroller, tote, or backpack as it&apos;s a 5-minute walk
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <TimelineTitle>
                Meeting Location: Lake Travis Marina
              </TimelineTitle>
              <TimelineBody>
                <List ordered>
                  <ListItem>
                  ...
                  <List nested>
                    ...
                    <ListItem>
                      If the gate is closed, send us a message for the gate
                      code.
                    </ListItem>
                  </List>
                  <ListItem>
                  ...
                  <List nested>
                    ...
                    <List nested>
                      <ListItem>
                        <strong>Red</strong>: Drive into Lake Travis Marina via
                        Hudson Bend Rd.
                      </ListItem>
                      <ListItem>
                      ...
                      <ListItem>
                        <strong>Yellow</strong>: Walk down the bridge into the
                        marina.
                      </ListItem>
                      <ListItem>
                  ...
                  <List nested>
                    <ListItem>
                      Use the restroom at the marina, as there is no toilet on
                      the boat.
                    </ListItem>
                    <ListItem>
                      Apply sunscreen before getting on the boat.
                    </ListItem>
                  </List>
                </List>
              </TimelineBody>
            ...
            <TimelineContent>
              ...
              <TimelineBody>
                <List>
                  ...
                  <List nested>
                    <ListItem>
                      Federal regulations require all children under 13 to wear
                      a life jacket at all times while on the boat.
                    </ListItem>
                  </List>
                  <ListItem>
                  ...
                  <List nested>
                    <ListItem>
                      Keep your hands inside the boat when getting on or off.
                      Our slip (boat parking spot) is tight, and we want to
                      avoid any accidents.
                    </ListItem>
                    <ListItem>
                      No shoes are allowed on the boat. Please use the provided
                  ...
                  <List nested>
                    <ListItem>
                      Lay down a blanket or towel if you’re feeding snacks to
                      children to keep things clean.
                    </ListItem>
                  </List>
                  <ListItem>
                  ...
                  <List nested>
                    <ListItem>
                      Always stay away from the engine when in the water and
                      make sure everyone wears a life jacket.
                    </ListItem>
                    <ListItem>
                      Stay seated while the boat is in motion. The lake can be
                      choppy, especially with other boats around.
                    </ListItem>
                  </List>
                  ...
                  <List nested>
                    <ListItem>
                      You are welcome to drive the boat, but please ensure you
                  ...
                  <List nested>
                    <ListItem>
                      We offer a variety of activities for your enjoyment. Let
                      us know how we can tailor the experience for you! Options
                      include:
                    </ListItem>
                    <List nested>
                      <ListItem>
                  ...
                  <List nested>
                    <ListItem>
                      Our boat has passed the 2024 US Coast Guard Vessel Safety
                      Check, so you’re in excellent hands!&nbsp;
                      <FigureComponent
            ...
            <TimelineContent>
              ...
              <TimelineBody>
                <List>
                  ...
                  <List nested>
                    <ListItem>
                      Please remain seated while we’re docking the boat for your
                      safety.
                    </ListItem>
                  </List>
                </List>
                <List>
                  ...
                  <List nested>
                    <ListItem>
                      Once docked, please clean up the boat and dispose of any
                      trash in the onboard trash bin.
                    </ListItem>
                    <ListItem>
                      Gather your belongings and place them outside of the boat.
                      Leave your lifejackets on the floor; we will secure them
                      to the back of the boat to air dry.
                    </ListItem>
                    <ListItem>
                      We might ask for assistance with looking after the kids
                      while we finish tidying up the boat.
                    </ListItem>
                  </List>
                </List>
                <List>
                  ...
                  <List nested>
                    <ListItem>
                      Feel free to use the restroom at the marina before you
                      leave, including changing out of your swimsuit. There’s
                      also a{" "}
                      <FigureComponent
